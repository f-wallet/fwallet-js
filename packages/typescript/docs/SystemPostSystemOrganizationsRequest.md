...
```typescript
import type { SystemPostSystemOrganizationsRequest } from '@f-wallet/typescript'
...
const example = {
  ...
  "config": null,
  "admin": null,
} satisfies SystemPostSystemOrganizationsRequest
...
const exampleParsed = JSON.parse(exampleJSON) as SystemPostSystemOrganizationsRequest
